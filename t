...
[1mOPTIONS[0m
       ...
       --force-with-lease=<refname>:<expect>
           ...
           advance with her commit, and blindly pushing with [1m--force [22mwill lose
           her work.
       ...
       --no-recurse-submodules, --recurse-submodules=check|on-demand|only|no
           ...
           superproject is left unpushed. A value of [4mno[24m or using
           [1m--no-recurse-submodules [22mcan be used to override the
...
[1mEXAMPLES[0m
       ...
       [1mgit push origin[0m
           ...
           configured upstream ([1mremote.origin.merge [22mconfiguration variable) if
...
Git 2.31.1                        03/26/2021                       GIT-PUSH(1)
